...
**ข้อมูลนักศึกษา:**
- ชื่อ: สุภาวดี เจริญไชย
- รหัสนักศึกษา: 66030194
- วันที่ทำการทดลอง: 27/10/68
...
1. เปรียบเทียบประสบการณ์การใช้ Docker ในสัปดาห์นี้กับสัปดาห์ที่ 4:
   ใช้งานได้คล่องขึ้น เข้าใจการสร้างและรัน container มากกว่าเดิม

2. สิ่งที่เรียนรู้เพิ่มเติมเกี่ยวกับ ESP32 architecture:
   รู้ว่า ESP32 มี dual-core, Wi-Fi, และ Bluetooth ในตัว

3. ความท้าทายที่พบในการทำ architecture analysis:
   ยากตรงการเข้าใจโครงสร้างภายในและการจัดการหน่วยความจำ
